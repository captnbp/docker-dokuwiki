...
RUN apk --no-cache add libressl2.4-libssl libressl2.4-libcrypto

RUN apk --no-cache --repository http://dl-cdn.alpinelinux.org/alpine/edge/community/ add \
    php7 php7-fpm php7-gd php7-session php7-xml php7-ldap php7-openssl php7-zlib libwebp nginx supervisor curl tar
